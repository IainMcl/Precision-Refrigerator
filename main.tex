...
\maketitle
\begin{abstract}
A precision refrigerator was built and controlled using a raspberry pi to precisely control the temperature of wine (water) by toggling the on/off state of a Peltier\cite{peltier} cooling unit. The efficiency of this cooling unit was then tested by comparing the energy consumed to change the temperature of the water with the specific heat capacity of water. The fridge was found to have a percentage efficiency of ............ \%. Following this, different methods for determining the on/off state of the Peltier were used. These converged on an aim temperature with different rates and efficiencies. A scoring system was devised to compare different convergence methods and the advantages and disadvantages of each were compared.
\end{abstract}
...
The efficency of the overall system is very low. This is a result of many factors: A lot of the energy removed when cooling will also be lost to the surroundings. 
